...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
	  ...
	  <li class="nav-item">
        <a class="nav-link" href="index.php?menu=kwj">
          <i class="fas fa-fw fa-check-circle"></i>
          <span>Kewajiban</span></a>
      </li>
	  <li class="nav-item">
        <a class="nav-link" href="index.php?menu=lar">
          <i class="fas fa-fw fa-exclamation-circle"></i>
          <span>Larangan</span></a>
      </li>
	  <li class="nav-item">
        <a class="nav-link" href="index.php?menu=huk">
          <i class="fas fa-fw fa-bullhorn"></i>
          <span>Tingkatan Hukuman Disiplin</span></a>
      </li>
	  <li class="nav-item">
        <a class="nav-link" href="index.php?menu=pel">
          <i class="fas fa-fw fa-times-circle"></i>
          <span>Pelanggaran</span></a>
      </li>
	  <li class="nav-item">
        <a class="nav-link" href="index.php?menu=pej">
